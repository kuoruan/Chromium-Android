  ...
  public  static final class MediaQueryCondition extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.MediaQueriesProto.MediaQueryCondition> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.MediaQueriesProto.MediaQueryCondition.class) {
              parser = PARSER;
              if (parser == null) {
  ...
  public  static final class FrameWidthCondition extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.MediaQueriesProto.FrameWidthCondition> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.MediaQueriesProto.FrameWidthCondition.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  public  static final class OrientationCondition extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.MediaQueriesProto.OrientationCondition> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.MediaQueriesProto.OrientationCondition.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  public  static final class DarkLightCondition extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.MediaQueriesProto.DarkLightCondition> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.MediaQueriesProto.DarkLightCondition.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
