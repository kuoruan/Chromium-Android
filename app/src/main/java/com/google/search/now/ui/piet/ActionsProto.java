  ...
  public  static final class Actions extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.ActionsProto.Actions> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.ActionsProto.Actions.class) {
              parser = PARSER;
              if (parser == null) {
  ...
  public  static final class Action extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.ActionsProto.Action> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.ActionsProto.Action.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  public  static final class VisibilityAction extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.ActionsProto.VisibilityAction> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.ActionsProto.VisibilityAction.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
