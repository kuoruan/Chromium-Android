  ...
  bitField0_ |= 0x00000020;
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.PietProto.Frame> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.PietProto.Frame.class) {
              parser = PARSER;
              if (parser == null) {
  ...
  bitField0_ |= 0x00000001;
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.PietProto.Stylesheet> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.PietProto.Stylesheet.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  templateStylesheetCase_ = 2;
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.PietProto.Template> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.PietProto.Template.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  public  static final class PietSharedState extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.PietProto.PietSharedState> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.PietProto.PietSharedState.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
