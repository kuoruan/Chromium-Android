  ...
  public  static final class FeedStream extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.wire.feed.FeedStreamProto.FeedStream> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.wire.feed.FeedStreamProto.FeedStream.class) {
              parser = PARSER;
              if (parser == null) {
