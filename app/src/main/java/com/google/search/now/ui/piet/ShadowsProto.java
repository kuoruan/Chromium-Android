  ...
  public  static final class Shadow extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.ShadowsProto.Shadow> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.ShadowsProto.Shadow.class) {
              parser = PARSER;
              if (parser == null) {
  ...
  public  static final class BoxShadow extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.ShadowsProto.BoxShadow> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.ShadowsProto.BoxShadow.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  public  static final class ElevationShadow extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.ui.piet.ShadowsProto.ElevationShadow> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.ui.piet.ShadowsProto.ElevationShadow.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
