  ...
  public  static final class MockServer extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.wire.feed.mockserver.MockServerProto.MockServer> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.wire.feed.mockserver.MockServerProto.MockServer.class) {
              parser = PARSER;
              if (parser == null) {
  ...
  public  static final class MockUpdate extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.wire.feed.mockserver.MockServerProto.MockUpdate> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.wire.feed.mockserver.MockServerProto.MockUpdate.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  bitField0_ |= 0x00000001;
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.google.search.now.wire.feed.mockserver.MockServerProto.ConditionalResponse> parser = PARSER;
          if (parser == null) {
            synchronized (com.google.search.now.wire.feed.mockserver.MockServerProto.ConditionalResponse.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
