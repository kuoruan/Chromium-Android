            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ON_RESPONSE_FOR_ABORT_PAYMENT_ORDINAL: {
                        ...
                        getImpl().onResponseForAbortPayment(data.paymentAborted, data.dispatchEventTime);
                        return true;
                    }
                    ...
                    case ON_RESPONSE_FOR_CAN_MAKE_PAYMENT_ORDINAL: {
                        ...
                        getImpl().onResponseForCanMakePayment(data.canMakePayment, data.dispatchEventTime);
                        return true;
                    }
                    ...
                    case ON_RESPONSE_FOR_PAYMENT_REQUEST_ORDINAL: {
                        ...
                        getImpl().onResponseForPaymentRequest(data.response, data.dispatchEventTime);
                        return true;
                    }
