...
int result) {
    ...
    static final class PaymentRequestClientOnShippingOptionChangeParams extends org.chromium.mojo.bindings.Struct {
        ...
        public int hashCode() {
            final int prime = 31;
            int result = prime + getClass().hashCode();
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.shippingOptionId);
            return result;
        }
    }
    ...
    static final class PaymentRequestClientOnAbortParams extends org.chromium.mojo.bindings.Struct {
        ...
        public int hashCode() {
            final int prime = 31;
            int result = prime + getClass().hashCode();
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.abortedSuccessfully);
            return result;
        }
    }
