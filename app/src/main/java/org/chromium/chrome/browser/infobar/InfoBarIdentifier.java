...
@IntDef({
    ...
    InfoBarIdentifier.POPUP_BLOCKED_INFOBAR_DELEGATE, InfoBarIdentifier.CHROME_SELECT_FILE_POLICY,
...
public @interface InfoBarIdentifier {
  ...
  /**
   * Removed: NATIVE_APP_INSTALLER_INFOBAR_DELEGATE = 52, Removed:
   * NATIVE_APP_LAUNCHER_INFOBAR_DELEGATE = 53, Removed: NATIVE_APP_OPEN_POLICY_INFOBAR_DELEGATE =
   * 54,
   */
