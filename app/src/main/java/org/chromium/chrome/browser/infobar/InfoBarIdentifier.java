...
public class InfoBarIdentifier {
  @IntDef({
      ...
      APP_BANNER_INFOBAR_DELEGATE_DESKTOP, ANDROID_DOWNLOAD_MANAGER_DUPLICATE_INFOBAR_DELEGATE,
      CHROME_DUPLICATE_DOWNLOAD_INFOBAR_DELEGATE, DOWNLOAD_REQUEST_INFOBAR_DELEGATE_ANDROID,
      ...
      SSL_ADD_CERTIFICATE, POPUP_BLOCKED_INFOBAR_DELEGATE, CHROME_SELECT_FILE_POLICY,
      KEYSTONE_PROMOTION_INFOBAR_DELEGATE, COLLECTED_COOKIES_INFOBAR_DELEGATE,
      INSTALLATION_ERROR_INFOBAR_DELEGATE, ALTERNATE_NAV_INFOBAR_DELEGATE, BAD_FLAGS_PROMPT,
      DEFAULT_BROWSER_INFOBAR_DELEGATE, GOOGLE_API_KEYS_INFOBAR_DELEGATE,
      OBSOLETE_SYSTEM_INFOBAR_DELEGATE, SESSION_CRASHED_INFOBAR_DELEGATE,
      WEBSITE_SETTINGS_INFOBAR_DELEGATE, AUTOFILL_CC_INFOBAR_DELEGATE, TRANSLATE_INFOBAR_DELEGATE,
      ...
      DATA_REDUCTION_PROXY_PREVIEW_INFOBAR_DELEGATE, SCREEN_CAPTURE_INFOBAR_DELEGATE_ANDROID,
      GROUPED_PERMISSION_INFOBAR_DELEGATE_ANDROID, OFFLINE_PAGE_INFOBAR_DELEGATE,
      SEARCH_GEOLOCATION_DISCLOSURE_INFOBAR_DELEGATE, AUTOMATION_INFOBAR_DELEGATE,
      VR_SERVICES_UPGRADE_ANDROID
  })
  ...
  public static final int ANDROID_DOWNLOAD_MANAGER_DUPLICATE_INFOBAR_DELEGATE = 3;
  public static final int CHROME_DUPLICATE_DOWNLOAD_INFOBAR_DELEGATE = 4;
  ...
  public static final int DATA_REDUCTION_PROXY_PREVIEW_INFOBAR_DELEGATE = 68;
  ...
  public static final int OFFLINE_PAGE_INFOBAR_DELEGATE = 71;
  public static final int SEARCH_GEOLOCATION_DISCLOSURE_INFOBAR_DELEGATE = 72;
