...
public final class ImageFilter extends org.chromium.mojo.bindings.Struct {
    ...
    private ImageFilter(int version) {
    ...
    public static ImageFilter deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static ImageFilter deserialize(java.nio.ByteBuffer data) {
        if (data == null)
            return null;
    ...
    public static ImageFilter decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new ImageFilter(mainDataHeader.elementsOrVersion);
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        ImageFilter other = (ImageFilter) object;
