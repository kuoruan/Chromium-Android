...
public static final int ERR_CERT_END = -216;
...
public static final int ERR_SPDY_PUSHED_STREAM_NOT_AVAILABLE = -373;
public static final int ERR_SPDY_CLAIMED_PUSHED_STREAM_RESET_BY_SERVER = -374;
public static final int ERR_TOO_MANY_RETRIES = -375;
public static final int ERR_SPDY_STREAM_CLOSED = -376;
public static final int ERR_SPDY_CLIENT_REFUSED_STREAM = -377;
public static final int ERR_SPDY_PUSHED_RESPONSE_DOES_NOT_MATCH = -378;
...
public static final int ERR_DNS_HTTP_FAILED = -807;
}
