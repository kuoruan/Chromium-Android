...
int type, org.chromium.net.interfaces.IpEndPoint localAddress, P2pPortRange portRange, P2pHostAndIpEndPoint remoteAddress, P2pSocketClient client, org.chromium.mojo.bindings.InterfaceRequest<P2pSocket> socket) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case GET_HOST_ADDRESS_ORDINAL: {
                        ...
                        getImpl().getHostAddress(data.hostName, new P2pSocketManagerGetHostAddressResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class P2pSocketManagerGetHostAddressResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(16, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public org.chromium.net.interfaces.IpAddress[] addresses;
            ...
            try {
                ...
                result = new P2pSocketManagerGetHostAddressResponseParams(elementsOrVersion);
                    ...
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(8, false);
                    {
                        ...
                        result.addresses = new org.chromium.net.interfaces.IpAddress[si1.elementsOrVersion];
                        for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                            
                            org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                            result.addresses[i1] = org.chromium.net.interfaces.IpAddress.decode(decoder2);
                        }
                    }
                    }
    ...
    static class P2pSocketManagerGetHostAddressResponseParamsProxyToResponder implements P2pSocketManager.GetHostAddressResponse {
        ...
        @Override
        public void call(org.chromium.net.interfaces.IpAddress[] addresses) {
    ...
    static final class P2pSocketManagerCreateSocketParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public int type;
        public org.chromium.net.interfaces.IpEndPoint localAddress;
        ...
        public static P2pSocketManagerCreateSocketParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new P2pSocketManagerCreateSocketParams(elementsOrVersion);
                    ...
                    result.localAddress = org.chromium.net.interfaces.IpEndPoint.decode(decoder1);
                    }
                    {
