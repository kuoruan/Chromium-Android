...
// For:
//     third_party/WebKit/common/service_worker/service_worker_error_type.mojom
//
...
public final class ServiceWorkerResponseError {
    ...
    public static final int LAST = (int) (ServiceWorkerResponseError.DATA_PIPE_CREATION_FAILED);
