...
public final class ConnectionMessage extends org.chromium.mojo.bindings.Struct {
    ...
    private ConnectionMessage(int version) {
    ...
    public static ConnectionMessage deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static ConnectionMessage deserialize(java.nio.ByteBuffer data) {
        if (data == null)
            return null;
    ...
    public static ConnectionMessage decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new ConnectionMessage(mainDataHeader.elementsOrVersion);
            if (mainDataHeader.elementsOrVersion >= 0) {
                
                result.type = decoder0.readInt(8);
                    PresentationMessageType.validate(result.type);
            }
            if (mainDataHeader.elementsOrVersion >= 0) {
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        ConnectionMessage other = (ConnectionMessage) object;
