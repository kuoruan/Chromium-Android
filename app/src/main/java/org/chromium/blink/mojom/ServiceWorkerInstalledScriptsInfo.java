...
public final class ServiceWorkerInstalledScriptsInfo extends org.chromium.mojo.bindings.Struct {
    ...
    public static ServiceWorkerInstalledScriptsInfo decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new ServiceWorkerInstalledScriptsInfo(mainDataHeader.elementsOrVersion);
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        ServiceWorkerInstalledScriptsInfo other = (ServiceWorkerInstalledScriptsInfo) object;
        if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.managerRequest, other.managerRequest))
            return false;
        if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.managerHostPtr, other.managerHostPtr))
            return false;
        if (!java.util.Arrays.deepEquals(this.installedUrls, other.installedUrls))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.managerRequest);
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.managerHostPtr);
        result = prime * result + java.util.Arrays.deepHashCode(this.installedUrls);
        return result;
    }
}