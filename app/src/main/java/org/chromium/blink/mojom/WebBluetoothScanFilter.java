...
public final class WebBluetoothScanFilter extends org.chromium.mojo.bindings.Struct {
    ...
    private WebBluetoothScanFilter(int version) {
    ...
    public static WebBluetoothScanFilter deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static WebBluetoothScanFilter deserialize(java.nio.ByteBuffer data) {
        if (data == null)
            return null;
    ...
    public static WebBluetoothScanFilter decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        WebBluetoothScanFilter result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            result = new WebBluetoothScanFilter(mainDataHeader.elementsOrVersion);
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        WebBluetoothScanFilter other = (WebBluetoothScanFilter) object;
