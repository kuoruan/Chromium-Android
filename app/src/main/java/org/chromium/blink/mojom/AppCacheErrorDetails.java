...
public final class AppCacheErrorDetails extends org.chromium.mojo.bindings.Struct {
    ...
    public static AppCacheErrorDetails deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static AppCacheErrorDetails decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
