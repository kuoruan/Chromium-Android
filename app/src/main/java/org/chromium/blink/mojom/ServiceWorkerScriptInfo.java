...
// For:
//     third_party/WebKit/public/mojom/service_worker/service_worker_installed_scripts_manager.mojom
//
...
public final class ServiceWorkerScriptInfo extends org.chromium.mojo.bindings.Struct {
    ...
    public static ServiceWorkerScriptInfo decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new ServiceWorkerScriptInfo(mainDataHeader.elementsOrVersion);
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        ServiceWorkerScriptInfo other = (ServiceWorkerScriptInfo) object;
        if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.scriptUrl, other.scriptUrl))
            return false;
        if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.encoding, other.encoding))
            return false;
        ...
        if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.metaData, other.metaData))
            return false;
        if (this.metaDataSize!= other.metaDataSize)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.scriptUrl);
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.encoding);
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.headers);
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.body);
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.bodySize);
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.metaData);
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.metaDataSize);
        return result;
    }
}