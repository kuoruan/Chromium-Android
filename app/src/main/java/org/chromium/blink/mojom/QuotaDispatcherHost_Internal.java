...
// For:
//     third_party/WebKit/common/quota/quota_dispatcher_host.mojom
//
...
long renderFrameId, org.chromium.url.mojom.Origin origin, int storageType, long requestedSize, 
RequestStorageQuotaResponse callback) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case REQUEST_STORAGE_QUOTA_ORDINAL: {
                        ...
                        getImpl().requestStorageQuota(data.renderFrameId, data.origin, data.storageType, data.requestedSize, new QuotaDispatcherHostRequestStorageQuotaResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class QuotaDispatcherHostQueryStorageUsageAndQuotaParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static QuotaDispatcherHostQueryStorageUsageAndQuotaParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new QuotaDispatcherHostQueryStorageUsageAndQuotaParams(mainDataHeader.elementsOrVersion);
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            QuotaDispatcherHostQueryStorageUsageAndQuotaParams other = (QuotaDispatcherHostQueryStorageUsageAndQuotaParams) object;
        ...
        public int hashCode() {
            ...
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.storageType);
            return result;
        }
    }
    ...
    static final class QuotaDispatcherHostQueryStorageUsageAndQuotaResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static QuotaDispatcherHostQueryStorageUsageAndQuotaResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new QuotaDispatcherHostQueryStorageUsageAndQuotaResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            QuotaDispatcherHostQueryStorageUsageAndQuotaResponseParams other = (QuotaDispatcherHostQueryStorageUsageAndQuotaResponseParams) object;
            if (this.error!= other.error)
                return false;
            if (this.currentUsage!= other.currentUsage)
                return false;
            if (this.currentQuota!= other.currentQuota)
                return false;
            return true;
        }
        ...
        public int hashCode() {
            ...
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.currentUsage);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.currentQuota);
            return result;
        }
    }
    ...
    static final class QuotaDispatcherHostRequestStorageQuotaParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static QuotaDispatcherHostRequestStorageQuotaParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new QuotaDispatcherHostRequestStorageQuotaParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
                    
                    result.renderFrameId = decoder0.readLong(8);
                }
                if (mainDataHeader.elementsOrVersion >= 0) {
                ...
                if (mainDataHeader.elementsOrVersion >= 0) {
                    ...
                    result.storageType = decoder0.readInt(24);
                        StorageType.validate(result.storageType);
                }
                if (mainDataHeader.elementsOrVersion >= 0) {
                    
                    result.requestedSize = decoder0.readLong(32);
                }
            } finally {
                decoder0.decreaseStackDepth();
            }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.storageType, 24);
            
            encoder0.encode(this.requestedSize, 32);
        }
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            QuotaDispatcherHostRequestStorageQuotaParams other = (QuotaDispatcherHostRequestStorageQuotaParams) object;
        ...
        public int hashCode() {
            ...
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.origin);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.storageType);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.requestedSize);
            return result;
        }
    }
    ...
    static final class QuotaDispatcherHostRequestStorageQuotaResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static QuotaDispatcherHostRequestStorageQuotaResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new QuotaDispatcherHostRequestStorageQuotaResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            QuotaDispatcherHostRequestStorageQuotaResponseParams other = (QuotaDispatcherHostRequestStorageQuotaResponseParams) object;
            if (this.error!= other.error)
                return false;
            if (this.currentUsage!= other.currentUsage)
                return false;
            if (this.grantedQuota!= other.grantedQuota)
                return false;
            return true;
        }
        ...
        public int hashCode() {
            ...
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.error);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.currentUsage);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.grantedQuota);
            return result;
        }
    }
