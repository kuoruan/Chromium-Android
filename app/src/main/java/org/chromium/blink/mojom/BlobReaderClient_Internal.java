...
int status, long dataLength) {
    ...
    static final class BlobReaderClientOnCalculatedSizeParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static BlobReaderClientOnCalculatedSizeParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new BlobReaderClientOnCalculatedSizeParams(mainDataHeader.elementsOrVersion);
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            BlobReaderClientOnCalculatedSizeParams other = (BlobReaderClientOnCalculatedSizeParams) object;
            if (this.totalSize!= other.totalSize)
                return false;
            if (this.expectedContentSize!= other.expectedContentSize)
                return false;
            return true;
        }
        ...
        public int hashCode() {
            ...
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.expectedContentSize);
            return result;
        }
    }
    ...
    static final class BlobReaderClientOnCompleteParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static BlobReaderClientOnCompleteParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new BlobReaderClientOnCompleteParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            BlobReaderClientOnCompleteParams other = (BlobReaderClientOnCompleteParams) object;
