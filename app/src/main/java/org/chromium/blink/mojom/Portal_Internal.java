...
class Portal_Internal {
    ...
    private static final int NAVIGATE_ORDINAL = 1;

    private static final int ACTIVATE_ORDINAL = 2;
...
InitResponse callback) {
            ...
            PortalInitParams _message = new PortalInitParams();
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(
                    _message.serializeWithHeader(
                            ...
                            new org.chromium.mojo.bindings.MessageHeader(
                                    ...
                                    0)),
                    new PortalInitResponseParamsForwardToCallback(callback));
...
ActivateResponse callback) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case INIT_ORDINAL: {
                        ...
                        PortalInitParams.deserialize(messageWithHeader.getPayload());

                        getImpl().init(new PortalInitResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class PortalInitParams extends org.chromium.mojo.bindings.Struct {

        private static final int STRUCT_SIZE = 8;
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(8, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];

        private PortalInitParams(int version) {
            super(STRUCT_SIZE, version);
        }

        public PortalInitParams() {
            this(0);
        }

        public static PortalInitParams deserialize(org.chromium.mojo.bindings.Message message) {
         ...
         */
        public static PortalInitParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static PortalInitParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            PortalInitParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new PortalInitParams(elementsOrVersion);
    ...
    static final class PortalInitResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private PortalInitResponseParams(int version) {
            super(STRUCT_SIZE, version);
        }

        public PortalInitResponseParams() {
            this(0);
        }

        public static PortalInitResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static PortalInitResponseParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static PortalInitResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            PortalInitResponseParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new PortalInitResponseParams(elementsOrVersion);
                    {
    ...
    static class PortalInitResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final Portal.InitResponse mCallback;

        PortalInitResponseParamsForwardToCallback(Portal.InitResponse callback) {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                PortalInitResponseParams response = PortalInitResponseParams.deserialize(messageWithHeader.getPayload());
    ...
    static class PortalInitResponseParamsProxyToResponder implements Portal.InitResponse {

        private final org.chromium.mojo.system.Core mCore;
        private final org.chromium.mojo.bindings.MessageReceiver mMessageReceiver;
        private final long mRequestId;

        PortalInitResponseParamsProxyToResponder(
        ...
        public void call(org.chromium.mojo_base.mojom.UnguessableToken token) {
            PortalInitResponseParams _response = new PortalInitResponseParams();
