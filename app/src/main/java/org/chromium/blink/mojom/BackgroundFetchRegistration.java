...
public final class BackgroundFetchRegistration extends org.chromium.mojo.bindings.Struct {
    ...
    public static BackgroundFetchRegistration decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new BackgroundFetchRegistration(mainDataHeader.elementsOrVersion);
            ...
            if (mainDataHeader.elementsOrVersion >= 0) {
                ...
                result.totalDownloadSize = decoder0.readLong(24);
            }
            if (mainDataHeader.elementsOrVersion >= 0) {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (icons == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(icons.length, 16, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        ...
        encoder0.encode(totalDownloadSize, 24);
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        BackgroundFetchRegistration other = (BackgroundFetchRegistration) object;
