...
public final class SyncRegistration extends org.chromium.mojo.bindings.Struct {
     ...
     */
    public static SyncRegistration deserialize(java.nio.ByteBuffer data) {
        if (data == null)
            return null;
    ...
    public static SyncRegistration decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        SyncRegistration result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            result = new SyncRegistration(mainDataHeader.elementsOrVersion);
            ...
            if (mainDataHeader.elementsOrVersion >= 0) {
                ...
                result.networkState = decoder0.readInt(24);
                    BackgroundSyncNetworkState.validate(result.networkState);
            }
        } finally {
