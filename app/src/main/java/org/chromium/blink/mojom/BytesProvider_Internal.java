...
RequestAsFileResponse callback) {
    ...
    static final class BytesProviderRequestAsReplyParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static BytesProviderRequestAsReplyParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new BytesProviderRequestAsReplyParams(mainDataHeader.elementsOrVersion);
            } finally {
    ...
    static final class BytesProviderRequestAsReplyResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static BytesProviderRequestAsReplyResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new BytesProviderRequestAsReplyResponseParams(mainDataHeader.elementsOrVersion);
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            BytesProviderRequestAsReplyResponseParams other = (BytesProviderRequestAsReplyResponseParams) object;
    ...
    static final class BytesProviderRequestAsStreamParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static BytesProviderRequestAsStreamParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new BytesProviderRequestAsStreamParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            BytesProviderRequestAsStreamParams other = (BytesProviderRequestAsStreamParams) object;
    ...
    static final class BytesProviderRequestAsFileParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static BytesProviderRequestAsFileParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new BytesProviderRequestAsFileParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            BytesProviderRequestAsFileParams other = (BytesProviderRequestAsFileParams) object;
            if (this.sourceOffset!= other.sourceOffset)
                return false;
            if (this.sourceSize!= other.sourceSize)
                return false;
        ...
        public int hashCode() {
            final int prime = 31;
            int result = prime + getClass().hashCode();
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.sourceOffset);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.sourceSize);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.file);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.fileOffset);
            return result;
        }
    }
    ...
    static final class BytesProviderRequestAsFileResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(16, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public org.chromium.mojo.common.mojom.Time timeFileModified;
        ...
        public static BytesProviderRequestAsFileResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new BytesProviderRequestAsFileResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
                    
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(8, true);
                    result.timeFileModified = org.chromium.mojo.common.mojom.Time.decode(decoder1);
                }
            } finally {
                decoder0.decreaseStackDepth();
            }
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            BytesProviderRequestAsFileResponseParams other = (BytesProviderRequestAsFileResponseParams) object;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.timeFileModified, other.timeFileModified))
                return false;
            return true;
        }
        ...
        public int hashCode() {
            final int prime = 31;
            int result = prime + getClass().hashCode();
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.timeFileModified);
            return result;
        }
    }
    ...
    static class BytesProviderRequestAsFileResponseParamsProxyToResponder implements BytesProvider.RequestAsFileResponse {
        ...
        @Override
        public void call(org.chromium.mojo.common.mojom.Time timeFileModified) {
