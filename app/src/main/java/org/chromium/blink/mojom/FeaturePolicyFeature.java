...
public final class FeaturePolicyFeature {
    ...
    public static final int DOCUMENT_WRITE = DOCUMENT_DOMAIN + 1;

    public static final int SYNC_SCRIPT = DOCUMENT_WRITE + 1;
    ...
    public static final int PICTURE_IN_PICTURE = UNSIZED_MEDIA + 1;

    public static final int LAST_FEATURE = (int) (FeaturePolicyFeature.PICTURE_IN_PICTURE);
