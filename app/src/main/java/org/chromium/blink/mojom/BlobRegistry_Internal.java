...
// For:
//     third_party/WebKit/public/mojom/blob/blob_registry.mojom
//
...
String contentType, String contentDisposition, long lengthHint, org.chromium.mojo.system.DataPipe.ConsumerHandle data, 
...
org.chromium.url.mojom.Origin origin, org.chromium.mojo.bindings.AssociatedInterfaceRequestNotSupported urlStore) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case REGISTER_FROM_STREAM_ORDINAL: {
                        ...
                        getImpl().registerFromStream(data.contentType, data.contentDisposition, data.lengthHint, data.data, new BlobRegistryRegisterFromStreamResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class BlobRegistryRegisterFromStreamParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static BlobRegistryRegisterFromStreamParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new BlobRegistryRegisterFromStreamParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            BlobRegistryRegisterFromStreamParams other = (BlobRegistryRegisterFromStreamParams) object;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.contentType, other.contentType))
                return false;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.contentDisposition, other.contentDisposition))
                return false;
            if (this.lengthHint!= other.lengthHint)
                return false;
        ...
        public int hashCode() {
            ...
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.contentType);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.contentDisposition);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.lengthHint);
    ...
    static final class BlobRegistryRegisterFromStreamResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static BlobRegistryRegisterFromStreamResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new BlobRegistryRegisterFromStreamResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            BlobRegistryRegisterFromStreamResponseParams other = (BlobRegistryRegisterFromStreamResponseParams) object;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.blob, other.blob))
                return false;
            return true;
        }
