...
public final class ParsedFeaturePolicyDeclaration extends org.chromium.mojo.bindings.Struct {
    ...
    public static ParsedFeaturePolicyDeclaration decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new ParsedFeaturePolicyDeclaration(mainDataHeader.elementsOrVersion);
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        ParsedFeaturePolicyDeclaration other = (ParsedFeaturePolicyDeclaration) object;
        if (this.feature!= other.feature)
            return false;
        if (this.matchesAllOrigins!= other.matchesAllOrigins)
            return false;
    ...
    public int hashCode() {
        ...
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.feature);
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.matchesAllOrigins);
        result = prime * result + java.util.Arrays.deepHashCode(this.origins);
        return result;
    }
}