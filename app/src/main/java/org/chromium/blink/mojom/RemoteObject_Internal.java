...
InvokeMethodResponse callback) {
    ...
    static final class RemoteObjectHasMethodParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static RemoteObjectHasMethodParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new RemoteObjectHasMethodParams(mainDataHeader.elementsOrVersion);
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            RemoteObjectHasMethodParams other = (RemoteObjectHasMethodParams) object;
    ...
    static final class RemoteObjectHasMethodResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static RemoteObjectHasMethodResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new RemoteObjectHasMethodResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            RemoteObjectHasMethodResponseParams other = (RemoteObjectHasMethodResponseParams) object;
            if (this.methodExists!= other.methodExists)
                return false;
            return true;
        }
        ...
        public int hashCode() {
            final int prime = 31;
            int result = prime + getClass().hashCode();
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.methodExists);
            return result;
        }
    }
    ...
    static final class RemoteObjectGetMethodsParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static RemoteObjectGetMethodsParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new RemoteObjectGetMethodsParams(mainDataHeader.elementsOrVersion);
            } finally {
                decoder0.decreaseStackDepth();
            }
            return result;
    ...
    static final class RemoteObjectGetMethodsResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static RemoteObjectGetMethodsResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new RemoteObjectGetMethodsResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            RemoteObjectGetMethodsResponseParams other = (RemoteObjectGetMethodsResponseParams) object;
            if (!java.util.Arrays.deepEquals(this.methodNames, other.methodNames))
                return false;
            return true;
        }
        ...
        public int hashCode() {
            final int prime = 31;
            int result = prime + getClass().hashCode();
            result = prime * result + java.util.Arrays.deepHashCode(this.methodNames);
            return result;
        }
    }
    ...
    static final class RemoteObjectInvokeMethodParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static RemoteObjectInvokeMethodParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new RemoteObjectInvokeMethodParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            RemoteObjectInvokeMethodParams other = (RemoteObjectInvokeMethodParams) object;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.name, other.name))
                return false;
            if (!java.util.Arrays.deepEquals(this.arguments, other.arguments))
                return false;
            return true;
        }
        ...
        public int hashCode() {
            ...
            int result = prime + getClass().hashCode();
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.name);
            result = prime * result + java.util.Arrays.deepHashCode(this.arguments);
            return result;
        }
    }
    ...
    static final class RemoteObjectInvokeMethodResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static RemoteObjectInvokeMethodResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new RemoteObjectInvokeMethodResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            RemoteObjectInvokeMethodResponseParams other = (RemoteObjectInvokeMethodResponseParams) object;
