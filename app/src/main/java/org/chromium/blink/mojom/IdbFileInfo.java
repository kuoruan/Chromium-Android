...
public final class IdbFileInfo extends org.chromium.mojo.bindings.Struct {
    ...
    private IdbFileInfo(int version) {
    ...
    public static IdbFileInfo deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static IdbFileInfo deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static IdbFileInfo decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new IdbFileInfo(elementsOrVersion);
                {
