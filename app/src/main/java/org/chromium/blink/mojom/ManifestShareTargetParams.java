...
public final class ManifestShareTargetParams extends org.chromium.mojo.bindings.Struct {
    ...
    public ManifestShareTargetFile[] files;
        ...
        try {
            ...
            result = new ManifestShareTargetParams(elementsOrVersion);
                ...
                if (decoder1 == null) {
                    ...
                    result.files = new ManifestShareTargetFile[si1.elementsOrVersion];
                    for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                        
                        org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                        result.files[i1] = ManifestShareTargetFile.decode(decoder2);
                    }
                }
                }
