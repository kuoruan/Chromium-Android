...
// For:
//     third_party/WebKit/common/clipboard/clipboard.mojom
//
...
class ClipboardHost_Internal {
    ...
    private static final int WRITE_STRING_TO_FIND_PBOARD_ORDINAL = 15;
...
int buffer, org.chromium.mojo.common.mojom.String16 type, 
...
int buffer, org.chromium.mojo.common.mojom.BigString16 text) {
...
int buffer, org.chromium.mojo.common.mojom.BigString16 markup, org.chromium.url.mojom.Url url) {
...
int buffer, java.util.Map<org.chromium.mojo.common.mojom.String16, org.chromium.mojo.common.mojom.BigString16> data) {
...
int buffer, String url, org.chromium.mojo.common.mojom.String16 title) {
...
int buffer) {
        ...
        @Override
        public void writeStringToFindPboard(
org.chromium.mojo.common.mojom.String16 text) {

            ClipboardHostWriteStringToFindPboardParams _message = new ClipboardHostWriteStringToFindPboardParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(WRITE_STRING_TO_FIND_PBOARD_ORDINAL)));
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case WRITE_STRING_TO_FIND_PBOARD_ORDINAL: {
            
                        ClipboardHostWriteStringToFindPboardParams data =
                                ClipboardHostWriteStringToFindPboardParams.deserialize(messageWithHeader.getPayload());
            
                        getImpl().writeStringToFindPboard(data.text);
                        return true;
                    }
    ...
    static final class ClipboardHostGetSequenceNumberParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostGetSequenceNumberParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new ClipboardHostGetSequenceNumberParams(mainDataHeader.elementsOrVersion);
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostGetSequenceNumberParams other = (ClipboardHostGetSequenceNumberParams) object;
    ...
    static final class ClipboardHostGetSequenceNumberResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostGetSequenceNumberResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostGetSequenceNumberResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostGetSequenceNumberResponseParams other = (ClipboardHostGetSequenceNumberResponseParams) object;
    ...
    static final class ClipboardHostIsFormatAvailableParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostIsFormatAvailableParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostIsFormatAvailableParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostIsFormatAvailableParams other = (ClipboardHostIsFormatAvailableParams) object;
    ...
    static final class ClipboardHostIsFormatAvailableResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostIsFormatAvailableResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostIsFormatAvailableResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostIsFormatAvailableResponseParams other = (ClipboardHostIsFormatAvailableResponseParams) object;
            if (this.result!= other.result)
                return false;
            return true;
        }
    ...
    static final class ClipboardHostReadAvailableTypesParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostReadAvailableTypesParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadAvailableTypesParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadAvailableTypesParams other = (ClipboardHostReadAvailableTypesParams) object;
            if (this.buffer!= other.buffer)
                return false;
            return true;
        }
    ...
    static final class ClipboardHostReadAvailableTypesResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public org.chromium.mojo.common.mojom.String16[] types;
        public boolean result;
        ...
        public static ClipboardHostReadAvailableTypesResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadAvailableTypesResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
                    
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(8, false);
                    {
                        org.chromium.mojo.bindings.DataHeader si1 = decoder1.readDataHeaderForPointerArray(org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                        result.types = new org.chromium.mojo.common.mojom.String16[si1.elementsOrVersion];
                        for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                            
                            org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                            result.types[i1] = org.chromium.mojo.common.mojom.String16.decode(decoder2);
                        }
                    }
                }
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadAvailableTypesResponseParams other = (ClipboardHostReadAvailableTypesResponseParams) object;
            if (!java.util.Arrays.deepEquals(this.types, other.types))
                return false;
            if (this.result!= other.result)
                return false;
            return true;
        ...
        public int hashCode() {
            final int prime = 31;
            int result = prime + getClass().hashCode();
            result = prime * result + java.util.Arrays.deepHashCode(this.types);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.result);
            return result;
        }
    }
    ...
    static class ClipboardHostReadAvailableTypesResponseParamsProxyToResponder implements ClipboardHost.ReadAvailableTypesResponse {
        ...
        @Override
        public void call(org.chromium.mojo.common.mojom.String16[] types, Boolean result) {
    ...
    static final class ClipboardHostReadTextParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostReadTextParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadTextParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadTextParams other = (ClipboardHostReadTextParams) object;
            if (this.buffer!= other.buffer)
                return false;
            return true;
        }
    ...
    static final class ClipboardHostReadTextResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(16, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public org.chromium.mojo.common.mojom.BigString16 result;
        ...
        public static ClipboardHostReadTextResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadTextResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
                    
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(8, false);
                    result.result = org.chromium.mojo.common.mojom.BigString16.decode(decoder1);
                }
            } finally {
                decoder0.decreaseStackDepth();
            }
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadTextResponseParams other = (ClipboardHostReadTextResponseParams) object;
    ...
    static class ClipboardHostReadTextResponseParamsProxyToResponder implements ClipboardHost.ReadTextResponse {
        ...
        @Override
        public void call(org.chromium.mojo.common.mojom.BigString16 result) {
    ...
    static final class ClipboardHostReadHtmlParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostReadHtmlParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadHtmlParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadHtmlParams other = (ClipboardHostReadHtmlParams) object;
            if (this.buffer!= other.buffer)
                return false;
            return true;
        }
    ...
    static final class ClipboardHostReadHtmlResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public org.chromium.mojo.common.mojom.BigString16 markup;
        ...
        public static ClipboardHostReadHtmlResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadHtmlResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
                    
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(8, false);
                    result.markup = org.chromium.mojo.common.mojom.BigString16.decode(decoder1);
                }
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadHtmlResponseParams other = (ClipboardHostReadHtmlResponseParams) object;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.markup, other.markup))
                return false;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.url, other.url))
                return false;
            if (this.fragmentStart!= other.fragmentStart)
                return false;
            if (this.fragmentEnd!= other.fragmentEnd)
                return false;
            return true;
        }
        ...
        public int hashCode() {
            final int prime = 31;
            int result = prime + getClass().hashCode();
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.markup);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.url);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.fragmentStart);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.fragmentEnd);
            return result;
        }
    }
    ...
    static class ClipboardHostReadHtmlResponseParamsProxyToResponder implements ClipboardHost.ReadHtmlResponse {
        ...
        @Override
        public void call(org.chromium.mojo.common.mojom.BigString16 markup, org.chromium.url.mojom.Url url, Integer fragmentStart, Integer fragmentEnd) {
    ...
    static final class ClipboardHostReadRtfParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostReadRtfParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadRtfParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadRtfParams other = (ClipboardHostReadRtfParams) object;
            if (this.buffer!= other.buffer)
                return false;
            return true;
        }
    ...
    static final class ClipboardHostReadRtfResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostReadRtfResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadRtfResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadRtfResponseParams other = (ClipboardHostReadRtfResponseParams) object;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.result, other.result))
                return false;
            return true;
        }
    ...
    static final class ClipboardHostReadImageParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostReadImageParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadImageParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadImageParams other = (ClipboardHostReadImageParams) object;
            if (this.buffer!= other.buffer)
                return false;
            return true;
        }
    ...
    static final class ClipboardHostReadImageResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostReadImageResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadImageResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
                    
                    result.blobUuid = decoder0.readString(8, false);
                }
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.blobUuid, 8, false);
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadImageResponseParams other = (ClipboardHostReadImageResponseParams) object;
        ...
        public int hashCode() {
            final int prime = 31;
            int result = prime + getClass().hashCode();
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.blobUuid);
    ...
    static class ClipboardHostReadImageResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                mCallback.call(response.blobUuid, response.mimeType, response.size);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
    ...
    static final class ClipboardHostReadCustomDataParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostReadCustomDataParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadCustomDataParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadCustomDataParams other = (ClipboardHostReadCustomDataParams) object;
            if (this.buffer!= other.buffer)
                return false;
    ...
    static final class ClipboardHostReadCustomDataResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostReadCustomDataResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostReadCustomDataResponseParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostReadCustomDataResponseParams other = (ClipboardHostReadCustomDataResponseParams) object;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.result, other.result))
                return false;
            return true;
        }
    ...
    static final class ClipboardHostWriteTextParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public int buffer;
        public org.chromium.mojo.common.mojom.BigString16 text;
        ...
        public static ClipboardHostWriteTextParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostWriteTextParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
                ...
                if (mainDataHeader.elementsOrVersion >= 0) {
                    ...
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(16, false);
                    result.text = org.chromium.mojo.common.mojom.BigString16.decode(decoder1);
                }
            } finally {
                decoder0.decreaseStackDepth();
            }
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostWriteTextParams other = (ClipboardHostWriteTextParams) object;
            if (this.buffer!= other.buffer)
                return false;
    ...
    static final class ClipboardHostWriteHtmlParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostWriteHtmlParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostWriteHtmlParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostWriteHtmlParams other = (ClipboardHostWriteHtmlParams) object;
            if (this.buffer!= other.buffer)
                return false;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.markup, other.markup))
                return false;
    ...
    static final class ClipboardHostWriteSmartPasteMarkerParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostWriteSmartPasteMarkerParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostWriteSmartPasteMarkerParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostWriteSmartPasteMarkerParams other = (ClipboardHostWriteSmartPasteMarkerParams) object;
            if (this.buffer!= other.buffer)
                return false;
            return true;
        }
    ...
    static final class ClipboardHostWriteCustomDataParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public int buffer;
        public java.util.Map<org.chromium.mojo.common.mojom.String16, org.chromium.mojo.common.mojom.BigString16> data;
        ...
        public static ClipboardHostWriteCustomDataParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostWriteCustomDataParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
                ...
                if (mainDataHeader.elementsOrVersion >= 0) {
                    ...
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(16, false);
                    {
                        ...
                        org.chromium.mojo.common.mojom.String16[] keys0;
                        org.chromium.mojo.common.mojom.BigString16[] values0;
                        {
                            ...
                            org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE, false);
                            {
                                ...
                                keys0 = new org.chromium.mojo.common.mojom.String16[si2.elementsOrVersion];
                                for (int i2 = 0; i2 < si2.elementsOrVersion; ++i2) {
                                    ...
                                    keys0[i2] = org.chromium.mojo.common.mojom.String16.decode(decoder3);
                                }
                            }
                        }
                        {
                            ...
                            org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE, false);
                            {
                                ...
                                values0 = new org.chromium.mojo.common.mojom.BigString16[si2.elementsOrVersion];
                                for (int i2 = 0; i2 < si2.elementsOrVersion; ++i2) {
                                    
                                    org.chromium.mojo.bindings.Decoder decoder3 = decoder2.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i2, false);
                                    values0[i2] = org.chromium.mojo.common.mojom.BigString16.decode(decoder3);
                                }
                            }
                        }
                        result.data = new java.util.HashMap<org.chromium.mojo.common.mojom.String16, org.chromium.mojo.common.mojom.BigString16>();
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            if (this.data == null) {
                ...
                org.chromium.mojo.common.mojom.String16[] keys0 = new org.chromium.mojo.common.mojom.String16[size0];
                org.chromium.mojo.common.mojom.BigString16[] values0 = new org.chromium.mojo.common.mojom.BigString16[size0];
                int index0 = 0;
                for (java.util.Map.Entry<org.chromium.mojo.common.mojom.String16, org.chromium.mojo.common.mojom.BigString16> entry0 : this.data.entrySet()) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostWriteCustomDataParams other = (ClipboardHostWriteCustomDataParams) object;
            if (this.buffer!= other.buffer)
                return false;
    ...
    static final class ClipboardHostWriteBookmarkParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostWriteBookmarkParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostWriteBookmarkParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostWriteBookmarkParams other = (ClipboardHostWriteBookmarkParams) object;
            if (this.buffer!= other.buffer)
                return false;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.url, other.url))
                return false;
    ...
    static final class ClipboardHostWriteImageParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostWriteImageParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostWriteImageParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostWriteImageParams other = (ClipboardHostWriteImageParams) object;
            if (this.buffer!= other.buffer)
                return false;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.sizeInPixels, other.sizeInPixels))
                return false;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.sharedBufferHandle, other.sharedBufferHandle))
                return false;
            return true;
        }
        ...
        public int hashCode() {
            ...
            int result = prime + getClass().hashCode();
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.buffer);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.sizeInPixels);
            result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(this.sharedBufferHandle);
            return result;
        }
    }
    ...
    static final class ClipboardHostCommitWriteParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ClipboardHostCommitWriteParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostCommitWriteParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostCommitWriteParams other = (ClipboardHostCommitWriteParams) object;
            if (this.buffer!= other.buffer)
                return false;
            return true;
        }
    ...
    static final class ClipboardHostWriteStringToFindPboardParams extends org.chromium.mojo.bindings.Struct {
    
        private static final int STRUCT_SIZE = 16;
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(16, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public org.chromium.mojo.common.mojom.String16 text;
    
        private ClipboardHostWriteStringToFindPboardParams(int version) {
            super(STRUCT_SIZE, version);
        }
    
        public ClipboardHostWriteStringToFindPboardParams() {
            this(0);
        }
    
        public static ClipboardHostWriteStringToFindPboardParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static ClipboardHostWriteStringToFindPboardParams deserialize(java.nio.ByteBuffer data) {
            if (data == null)
                return null;
        ...
        @SuppressWarnings("unchecked")
        public static ClipboardHostWriteStringToFindPboardParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ClipboardHostWriteStringToFindPboardParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                result = new ClipboardHostWriteStringToFindPboardParams(mainDataHeader.elementsOrVersion);
                if (mainDataHeader.elementsOrVersion >= 0) {
                    
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(8, false);
                    result.text = org.chromium.mojo.common.mojom.String16.decode(decoder1);
                }
            } finally {
                decoder0.decreaseStackDepth();
            }
        ...
        public boolean equals(Object object) {
            ...
            if (getClass() != object.getClass())
                return false;
            ClipboardHostWriteStringToFindPboardParams other = (ClipboardHostWriteStringToFindPboardParams) object;
            if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.text, other.text))
                return false;
            return true;
        }
